                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="post-title">
                                                    ...
                                                    <span class="meta-data"><i class="fa fa-calendar"></i> on 17th Jan, 2020</span></div>
                                    ...
                                    <li class="item post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="post-title">
                                                    <h2><a href="blog-post.html">Voluptatum deleniti atque corrupti</a></h2>
                                                    <span class="meta-data"><i class="fa fa-calendar"></i> on 15th Jan, 2020</span></div>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus.</p>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <section class="listing-cont">
                                <ul>
                                    ...
                                    <li class="item sermon">
                                        ...
                                        <span class="meta-data"><i class="fa fa-calendar"></i> on 17th Jan, 2020</span> </li>
                                    <li class="item sermon">
                                        <h2 class="sermon-title"><a href="single-sermon.html">Voluptatum deleniti atque corrupti</a></h2>
                                        <span class="meta-data"><i class="fa fa-calendar"></i> on 14th Jan, 2020</span> </li>
                                    <li class="item sermon">
                                        <h2 class="sermon-title"><a href="single-sermon.html">Voluptatum deleniti atque corrupti</a></h2>
                                        <span class="meta-data"><i class="fa fa-calendar"></i> on 11th Jan, 2020</span> </li>
                                </ul>
                            </section>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="copyrights-col-left col-md-6 col-sm-6">
                    <p>&copy; 2020 NativeChurch. All Rights Reserved</p>
                </div>
...
<script src="assets/plugins/js/prettyphoto.js"></script> <!-- PrettyPhoto Plugin -->
<script src="js/helper-plugins.js"></script> <!-- Plugins -->
<script src="js/bootstrap.js"></script> <!-- UI -->
<script src="js/waypoints.js"></script> <!-- Waypoints -->
<script src="plugins/mediaelement/mediaelement-and-player.min.js"></script> <!-- MediaElements -->
<script src="js/init.js"></script> <!-- All Scripts -->
<script src="assets/plugins/js/jquery.flexslider.js"></script> <!-- FlexSlider -->
