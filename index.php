        ...
        <div class="row">
            ...
            <div class="col-12" data-aos="fade-up">
                <div class="intro4-content headline-active text-center">
                    ...
                    <a href="https://www.youtube.com/watch?v=JHKCofpUosk" class="btn btn-outline-light btn-hover-primary video-popup" style="font-weight: 300">
                        ...
                        <div class="event max-mb-30">
                            <div class="thumbnail">
                                <a href="eventdetails?id=<?php echo lock($eventid) ?>" class="image">
                                    <img src="../ms/<?php echo $resevents['image_location'] ?>" style="width: 391px;height: 181px" alt="Event Image">
                                </a>
                                <div class="event-overlay-background"></div>
                                <div class="event-overlay-content">
                                    <a class="btn btn-md btn-light btn-hover-light theme-color" href="eventdetails?id=<?php echo lock($eventid) ?>">View Details</a>
                                </div>
                            </div>
                            <div class="info">
                                <span class="date">
