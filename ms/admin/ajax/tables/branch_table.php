...
$pinq = $mysqli->query("select * from branch ORDER BY name");
?>
<style>
    .dataTables_filter {
        display: none;
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="kt-nav">
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link edit_branch"
                                            ...
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link delete_branch"
                                                   i_index="<?php echo $fetch['id'] ?>" href="#"> <i
...
<script>
    ...
    $(document).off('click', '.edit_branch').on('click', '.edit_branch', function () {
        var theindex = $(this).attr('i_index');
        //alert(theindex)
        $.ajax({
            type: "POST",
            url: "ajax/forms/editform_branch.php",
            data: {
                i_index: theindex
            },
            dataType: "html",
