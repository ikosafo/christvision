...
$getatt = $mysqli->query("select * from attendancemeeting where branch = '$branch' AND
                              datereported >= '$datefrom' AND datereported <= '$dateto'");
                ...
                while ($fetch = $getatt->fetch_assoc()) {
                    ...
                    <tr>
                        <td>
                            ...
                            $getservice = $mysqli->query("select * from meeting_config where configid = '$configid'");
                            $resservice = $getservice->fetch_assoc();
                           echo $resservice['title']
                            ?>
                        </td>
                        <td>
                            <?php
