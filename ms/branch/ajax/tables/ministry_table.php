...
$pinq = $mysqli->query("select * from ministry where branch = '$branch' ORDER BY ministry_name");
?>
<style>
    .dataTables_filter {
        display: none;
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="kt-nav">
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link edit_ministry"
                                            ...
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link delete_ministry"
                                                   i_index="<?php echo $fetch['id'] ?>" href="#"> <i
...
<script>
    ...
    $(document).off('click', '.edit_ministry').on('click', '.edit_ministry', function () {
        var theindex = $(this).attr('i_index');
        //alert(theindex)
        $.ajax({
            type: "POST",
            url: "ajax/forms/editform_ministry.php",
            data: {
                i_index: theindex
            },
            dataType: "html",
